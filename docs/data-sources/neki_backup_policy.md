...
page_title: "planetscale_neki_backup_policy Data Source - terraform-provider-planetscale"
subcategory: ""
description: |-
  NekiBackupPolicy DataSource
---

# planetscale_neki_backup_policy (Data Source)
...
```terraform
data "planetscale_neki_backup_policy" "my_nekibackuppolicy" {
