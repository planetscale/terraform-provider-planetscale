...
page_title: "planetscale_neki_database Data Source - terraform-provider-planetscale"
subcategory: ""
description: |-
  NekiDatabase DataSource
---

# planetscale_neki_database (Data Source)
...
```terraform
data "planetscale_neki_database" "my_nekidatabase" {
  id           = "...my_id..."
