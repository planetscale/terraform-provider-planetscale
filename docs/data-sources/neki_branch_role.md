...
page_title: "planetscale_neki_branch_role Data Source - terraform-provider-planetscale"
subcategory: ""
description: |-
  NekiBranchRole DataSource
---

# planetscale_neki_branch_role (Data Source)
...
```terraform
data "planetscale_neki_branch_role" "my_nekibranchrole" {
  branch       = "...my_branch..."
