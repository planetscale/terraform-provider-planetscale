...
page_title: "planetscale_neki_redacted_branch_role Data Source - terraform-provider-planetscale"
subcategory: ""
description: |-
  NekiRedactedBranchRole DataSource
---

# planetscale_neki_redacted_branch_role (Data Source)
...
```terraform
data "planetscale_neki_redacted_branch_role" "my_nekiredactedbranchrole" {
  branch       = "...my_branch..."
