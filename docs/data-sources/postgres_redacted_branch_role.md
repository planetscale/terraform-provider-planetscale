...
page_title: "planetscale_postgres_redacted_branch_role Data Source - terraform-provider-planetscale"
subcategory: ""
description: |-
  PostgresRedactedBranchRole DataSource
---

# planetscale_postgres_redacted_branch_role (Data Source)
...
```terraform
data "planetscale_postgres_redacted_branch_role" "my_postgresredactedbranchrole" {
  branch       = "...my_branch..."
