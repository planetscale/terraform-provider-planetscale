...
page_title: "planetscale_neki_backup_policies Data Source - terraform-provider-planetscale"
subcategory: ""
description: |-
  NekiBackupPolicies DataSource
---

# planetscale_neki_backup_policies (Data Source)
...
```terraform
data "planetscale_neki_backup_policies" "my_nekibackuppolicies" {
