...
page_title: "planetscale_neki_redacted_branch_role Resource - terraform-provider-planetscale"
subcategory: ""
description: |-
  NekiRedactedBranchRole Resource
---

# planetscale_neki_redacted_branch_role (Resource)
...
```terraform
import {
  to = planetscale_neki_redacted_branch_role.my_planetscale_neki_redacted_branch_role
  id = jsonencode({
    branch       = "..."
    database     = "..."
    id           = "..."
...
```shell
terraform import planetscale_neki_redacted_branch_role.my_planetscale_neki_redacted_branch_role '{"branch": "...", "database": "...", "id": "...", "organization": "..."}'
```
