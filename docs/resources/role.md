...
page_title: "planetscale_role Resource - terraform-provider-planetscale"
subcategory: ""
description: |-
  Role Resource
---

# planetscale_role (Resource)
...
```terraform
import {
  to = planetscale_role.my_planetscale_role
  id = jsonencode({
    branch = "..."
    database = "..."
    id = "..."
...
```shell
terraform import planetscale_role.my_planetscale_role '{"branch": "...", "database": "...", "id": "...", "organization": "..."}'
```
