...
page_title: "planetscale_postgres_redacted_branch_role Resource - terraform-provider-planetscale"
subcategory: ""
description: |-
  PostgresRedactedBranchRole Resource
---

# planetscale_postgres_redacted_branch_role (Resource)
...
```shell
terraform import planetscale_postgres_redacted_branch_role.my_planetscale_postgres_redacted_branch_role '{"branch": "...", "database": "...", "id": "...", "organization": "..."}'
```
