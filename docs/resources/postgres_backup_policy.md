...
page_title: "planetscale_postgres_backup_policy Resource - terraform-provider-planetscale"
subcategory: ""
description: |-
  PostgresBackupPolicy Resource
---

# planetscale_postgres_backup_policy (Resource)
...
```terraform
import {
  to = planetscale_postgres_backup_policy.my_planetscale_postgres_backup_policy
  id = jsonencode({
    database     = "..."
    id           = "..."
    organization = "..."
...
```shell
terraform import planetscale_postgres_backup_policy.my_planetscale_postgres_backup_policy '{"database": "...", "id": "...", "organization": "..."}'
```
