...
page_title: "planetscale_vitess_branch_backup Resource - terraform-provider-planetscale"
subcategory: ""
description: |-
  VitessBranchBackup Resource
---

# planetscale_vitess_branch_backup (Resource)
...
```shell
terraform import planetscale_vitess_branch_backup.my_planetscale_vitess_branch_backup '{"branch": "...", "database": "...", "id": "...", "organization": "..."}'
```
