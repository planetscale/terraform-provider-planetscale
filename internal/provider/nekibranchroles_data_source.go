...
var _ datasource.DataSource = &NekiBranchRolesDataSource{}
var _ datasource.DataSourceWithConfigure = &NekiBranchRolesDataSource{}

func NewNekiBranchRolesDataSource() datasource.DataSource {
	return &NekiBranchRolesDataSource{}
}

// NekiBranchRolesDataSource is the data source implementation.
type NekiBranchRolesDataSource struct {
	// Provider configured SDK client.
	client *sdk.PlanetScale
}

// NekiBranchRolesDataSourceModel describes the data model.
type NekiBranchRolesDataSourceModel struct {
...
func (r *NekiBranchRolesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_neki_branch_roles"
}

// Schema defines the schema for the data source.
func (r *NekiBranchRolesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "NekiBranchRoles DataSource",
...
func (r *NekiBranchRolesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *NekiBranchRolesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *NekiBranchRolesDataSourceModel
