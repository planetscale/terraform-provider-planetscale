...
var _ datasource.DataSource = &PostgresBouncerDataSource{}
var _ datasource.DataSourceWithConfigure = &PostgresBouncerDataSource{}

func NewPostgresBouncerDataSource() datasource.DataSource {
	return &PostgresBouncerDataSource{}
}

// PostgresBouncerDataSource is the data source implementation.
type PostgresBouncerDataSource struct {
...
func (r *PostgresBouncerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_postgres_bouncer"
}

// Schema defines the schema for the data source.
func (r *PostgresBouncerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PostgresBouncer DataSource",
...
func (r *PostgresBouncerDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PostgresBouncerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PostgresBouncerDataSourceModel
