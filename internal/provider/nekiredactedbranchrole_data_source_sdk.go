...
func (r *NekiRedactedBranchRoleDataSourceModel) RefreshFromOperationsGetNekiRedactedRoleResponseBody(ctx context.Context, resp *operations.GetNekiRedactedRoleResponseBody) diag.Diagnostics {
...
func (r *NekiRedactedBranchRoleDataSourceModel) ToOperationsGetNekiRedactedRoleRequest(ctx context.Context) (*operations.GetNekiRedactedRoleRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
