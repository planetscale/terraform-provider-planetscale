...
func (r *NekiBranchRolesDataSourceModel) RefreshFromOperationsListNekiRolesResponseBody(ctx context.Context, resp *operations.ListNekiRolesResponseBody) diag.Diagnostics {
	...
	if resp != nil {
		...
		for _, dataItem := range resp.Data {
			...
			data.Actor = &tfTypes.ListNekiRolesActor{}
			...
			data.Branch = &tfTypes.ListNekiRolesBranch{}
			...
			data.QuerySafetySettings = &tfTypes.ListNekiRolesQuerySafetySettings{}
...
func (r *NekiBranchRolesDataSourceModel) ToOperationsListNekiRolesRequest(ctx context.Context) (*operations.ListNekiRolesRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
