...
func (r *NekiBranchRoleDataSourceModel) RefreshFromOperationsGetNekiRoleResponseBody(ctx context.Context, resp *operations.GetNekiRoleResponseBody) diag.Diagnostics {
...
func (r *NekiBranchRoleDataSourceModel) ToOperationsGetNekiRoleRequest(ctx context.Context) (*operations.GetNekiRoleRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
