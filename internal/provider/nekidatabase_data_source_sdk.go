...
func (r *NekiDatabaseDataSourceModel) RefreshFromOperationsGetNekiDatabaseResponseBody(ctx context.Context, resp *operations.GetNekiDatabaseResponseBody) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.DataImport == nil {
			...
			r.DataImport = &tfTypes.GetNekiDatabaseDataImport{}
			r.DataImport.DataSource = &tfTypes.GetNekiDatabaseDataSource{}
		...
		r.RegionData = &tfTypes.GetNekiDatabaseRegionData{}
...
func (r *NekiDatabaseDataSourceModel) ToOperationsGetNekiDatabaseRequest(ctx context.Context) (*operations.GetNekiDatabaseRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.GetNekiDatabaseRequest{
