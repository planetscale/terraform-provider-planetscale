...
func (r *PasswordDataSourceModel) RefreshFromOperationsGetPasswordResponseBody(ctx context.Context, resp *operations.GetPasswordResponseBody) diag.Diagnostics {
...
func (r *PasswordDataSourceModel) ToOperationsGetPasswordRequest(ctx context.Context) (*operations.GetPasswordRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
