...
func (r *BackupResourceModel) RefreshFromOperationsCreateBackupResponseBody(ctx context.Context, resp *operations.CreateBackupResponseBody) diag.Diagnostics {
...
func (r *BackupResourceModel) RefreshFromOperationsGetBackupResponseBody(ctx context.Context, resp *operations.GetBackupResponseBody) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (r *BackupResourceModel) RefreshFromOperationsUpdateBackupResponseBody(ctx context.Context, resp *operations.UpdateBackupResponseBody) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (r *BackupResourceModel) ToOperationsCreateBackupRequest(ctx context.Context) (*operations.CreateBackupRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	body, bodyDiags := r.ToOperationsCreateBackupRequestBody(ctx)
	...
	out := operations.CreateBackupRequest{
...
func (r *BackupResourceModel) ToOperationsCreateBackupRequestBody(ctx context.Context) (*operations.CreateBackupRequestBody, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	retentionUnit := new(operations.RetentionUnit)
	if !r.RetentionUnit.IsUnknown() && !r.RetentionUnit.IsNull() {
		*retentionUnit = operations.RetentionUnit(r.RetentionUnit.ValueString())
	} else {
		retentionUnit = nil
	}
	retentionValue := new(float64)
	if !r.RetentionValue.IsUnknown() && !r.RetentionValue.IsNull() {
		*retentionValue = r.RetentionValue.ValueFloat64()
	} else {
		retentionValue = nil
	}
	emergency := new(bool)
	...
	out := operations.CreateBackupRequestBody{
		Name:           name,
...
func (r *BackupResourceModel) ToOperationsDeleteBackupRequest(ctx context.Context) (*operations.DeleteBackupRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.DeleteBackupRequest{
		ID:           id,
		Organization: organization,
		Database:     database,
		Branch:       branch,
...
func (r *BackupResourceModel) ToOperationsGetBackupRequest(ctx context.Context) (*operations.GetBackupRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *BackupResourceModel) ToOperationsUpdateBackupRequest(ctx context.Context) (*operations.UpdateBackupRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	body, bodyDiags := r.ToOperationsUpdateBackupRequestBody(ctx)
	diags.Append(bodyDiags...)
	...
	out := operations.UpdateBackupRequest{
		ID:           id,
		Organization: organization,
		Database:     database,
		Branch:       branch,
...
func (r *BackupResourceModel) ToOperationsUpdateBackupRequestBody(ctx context.Context) (*operations.UpdateBackupRequestBody, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.UpdateBackupRequestBody{
		Protected: protected,
	}
