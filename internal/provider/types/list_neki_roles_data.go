...
type ListNekiRolesData struct {
	...
	Actor                        *ListNekiRolesActor               `tfsdk:"actor"`
	BaseUsername                 types.String                      `tfsdk:"base_username"`
	Branch                       *ListNekiRolesBranch              `tfsdk:"branch"`
	...
	QuerySafetySettings          *ListNekiRolesQuerySafetySettings `tfsdk:"query_safety_settings"`
