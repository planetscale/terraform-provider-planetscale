...
func (r *NekiSidecarDataSourceModel) RefreshFromOperationsGetNekiSidecarParametersResponseBody(ctx context.Context, resp *operations.GetNekiSidecarParametersResponseBody) diag.Diagnostics {
...
func (r *NekiSidecarDataSourceModel) RefreshFromOperationsGetNekiSidecarResponseBody(ctx context.Context, resp *operations.GetNekiSidecarResponseBody) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (r *NekiSidecarDataSourceModel) ToOperationsGetNekiSidecarParametersRequest(ctx context.Context) (*operations.GetNekiSidecarParametersRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *NekiSidecarDataSourceModel) ToOperationsGetNekiSidecarRequest(ctx context.Context) (*operations.GetNekiSidecarRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
