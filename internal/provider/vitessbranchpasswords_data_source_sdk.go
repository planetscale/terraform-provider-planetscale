...
func (r *VitessBranchPasswordsDataSourceModel) RefreshFromOperationsListPasswordsResponseBody(ctx context.Context, resp *operations.ListPasswordsResponseBody) diag.Diagnostics {
	...
	if resp != nil {
		...
		for _, dataItem := range resp.Data {
			...
			data.LastUsedAt = types.StringPointerValue(dataItem.LastUsedAt)
			data.Name = types.StringValue(dataItem.Name)
			data.PlainText = types.StringPointerValue(dataItem.PlainText)
			...
			data.TTLSeconds = types.Int64PointerValue(dataItem.TTLSeconds)
