...
var _ datasource.DataSource = &NekiBranchBackupsDataSource{}
var _ datasource.DataSourceWithConfigure = &NekiBranchBackupsDataSource{}

func NewNekiBranchBackupsDataSource() datasource.DataSource {
	return &NekiBranchBackupsDataSource{}
}

// NekiBranchBackupsDataSource is the data source implementation.
type NekiBranchBackupsDataSource struct {
	// Provider configured SDK client.
	client *sdk.PlanetScale
}

// NekiBranchBackupsDataSourceModel describes the data model.
type NekiBranchBackupsDataSourceModel struct {
	All          types.Bool                          `queryParam:"style=form,explode=true,name=all" tfsdk:"all"`
	Branch       types.String                        `tfsdk:"branch"`
	Data         []tfTypes.ListNekiBranchBackupsData `tfsdk:"data"`
...
func (r *NekiBranchBackupsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_neki_branch_backups"
}

// Schema defines the schema for the data source.
func (r *NekiBranchBackupsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "NekiBranchBackups DataSource",
...
func (r *NekiBranchBackupsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *NekiBranchBackupsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *NekiBranchBackupsDataSourceModel
	...
	request, requestDiags := data.ToOperationsListNekiBranchBackupsRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.Backups.ListNekiBranchBackups(ctx, *request)
	if err != nil {
	...
	data.Data = nil
	resp.Diagnostics.Append(data.RefreshFromOperationsListNekiBranchBackupsResponseBody(ctx, res.Object)...)
