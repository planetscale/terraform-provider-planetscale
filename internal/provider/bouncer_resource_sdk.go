...
func (r *BouncerResourceModel) RefreshFromOperationsCreateBouncerResponseBody(ctx context.Context, resp *operations.CreateBouncerResponseBody) diag.Diagnostics {
...
func (r *BouncerResourceModel) RefreshFromOperationsGetBouncerResponseBody(ctx context.Context, resp *operations.GetBouncerResponseBody) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (r *BouncerResourceModel) ToOperationsCreateBouncerRequest(ctx context.Context) (*operations.CreateBouncerRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *BouncerResourceModel) ToOperationsCreateBouncerRequestBody(ctx context.Context) (*operations.CreateBouncerRequestBody, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	replicasPerCell := new(float64)
	if !r.ReplicasPerCell.IsUnknown() && !r.ReplicasPerCell.IsNull() {
		*replicasPerCell = r.ReplicasPerCell.ValueFloat64()
	} else {
		replicasPerCell = nil
	}
...
func (r *BouncerResourceModel) ToOperationsDeleteBouncerRequest(ctx context.Context) (*operations.DeleteBouncerRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *BouncerResourceModel) ToOperationsGetBouncerRequest(ctx context.Context) (*operations.GetBouncerRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
