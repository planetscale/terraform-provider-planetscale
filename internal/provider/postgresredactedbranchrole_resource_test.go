...
func TestAccPostgresRedactedBranchRoleResource_Lifecycle(t *testing.T) {
	t.Parallel()
	...
	resourceAddress := "planetscale_postgres_redacted_branch_role.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckNoResourceAttr(resourceAddress, "password"),
				),
