...
func (r *DatabasesDataSourceModel) RefreshFromOperationsListDatabasesResponseBody(ctx context.Context, resp *operations.ListDatabasesResponseBody) diag.Diagnostics {
	...
	if resp != nil {
		...
		for _, dataItem := range resp.Data {
			...
			data.BranchesCount = types.Float64Value(dataItem.BranchesCount)
			...
			data.DataImport.DataSource.Port = types.Float64Value(dataItem.DataImport.DataSource.Port)
			...
			data.DefaultBranchReadOnlyRegionsCount = types.Float64Value(dataItem.DefaultBranchReadOnlyRegionsCount)
			data.DefaultBranchShardCount = types.Float64Value(dataItem.DefaultBranchShardCount)
			data.DefaultBranchTableCount = types.Float64Value(dataItem.DefaultBranchTableCount)
			data.DevelopmentBranchesCount = types.Float64Value(dataItem.DevelopmentBranchesCount)
			...
			data.IssuesCount = types.Float64Value(dataItem.IssuesCount)
			...
			data.OpenSchemaRecommendationsCount = types.Float64Value(dataItem.OpenSchemaRecommendationsCount)
			...
			data.ProductionBranchesCount = types.Float64Value(dataItem.ProductionBranchesCount)
