...
var _ datasource.DataSource = &NekiBranchRoleDataSource{}
var _ datasource.DataSourceWithConfigure = &NekiBranchRoleDataSource{}

func NewNekiBranchRoleDataSource() datasource.DataSource {
	return &NekiBranchRoleDataSource{}
}

// NekiBranchRoleDataSource is the data source implementation.
type NekiBranchRoleDataSource struct {
	// Provider configured SDK client.
	client *sdk.PlanetScale
}

// NekiBranchRoleDataSourceModel describes the data model.
type NekiBranchRoleDataSourceModel struct {
...
func (r *NekiBranchRoleDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_neki_branch_role"
}

// Schema defines the schema for the data source.
func (r *NekiBranchRoleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "NekiBranchRole DataSource",
...
func (r *NekiBranchRoleDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *NekiBranchRoleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *NekiBranchRoleDataSourceModel
