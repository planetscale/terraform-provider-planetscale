...
func (r *NekiBackupPoliciesDataSourceModel) RefreshFromOperationsListNekiBackupPoliciesResponseBody(ctx context.Context, resp *operations.ListNekiBackupPoliciesResponseBody) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		if r.Data == nil {
			r.Data = []tfTypes.ListNekiBackupPoliciesData{}
		}

		for _, dataItem := range resp.Data {
			var data tfTypes.ListNekiBackupPoliciesData
...
func (r *NekiBackupPoliciesDataSourceModel) ToOperationsListNekiBackupPoliciesRequest(ctx context.Context) (*operations.ListNekiBackupPoliciesRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.ListNekiBackupPoliciesRequest{
