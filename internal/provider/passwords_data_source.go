...
var _ datasource.DataSource = &PasswordsDataSource{}
var _ datasource.DataSourceWithConfigure = &PasswordsDataSource{}
...
// PasswordsDataSourceModel describes the data model.
...
func (r *PasswordsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_passwords"
}

// Schema defines the schema for the data source.
func (r *PasswordsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Passwords DataSource",
...
func (r *PasswordsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PasswordsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
