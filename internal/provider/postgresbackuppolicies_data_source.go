...
var _ datasource.DataSource = &PostgresBackupPoliciesDataSource{}
var _ datasource.DataSourceWithConfigure = &PostgresBackupPoliciesDataSource{}

func NewPostgresBackupPoliciesDataSource() datasource.DataSource {
	return &PostgresBackupPoliciesDataSource{}
}
...
func (r *PostgresBackupPoliciesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_postgres_backup_policies"
}
...
func (r *PostgresBackupPoliciesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PostgresBackupPolicies DataSource",
...
func (r *PostgresBackupPoliciesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PostgresBackupPoliciesDataSourceModel
	...
	request, requestDiags := data.ToOperationsListPostgresBackupPoliciesRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.BackupPolicies.ListPostgresBackupPolicies(ctx, *request)
	if err != nil {
	...
	data.Data = nil
	resp.Diagnostics.Append(data.RefreshFromOperationsListPostgresBackupPoliciesResponseBody(ctx, res.Object)...)
