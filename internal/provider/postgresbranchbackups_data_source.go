...
var _ datasource.DataSource = &PostgresBranchBackupsDataSource{}
var _ datasource.DataSourceWithConfigure = &PostgresBranchBackupsDataSource{}

func NewPostgresBranchBackupsDataSource() datasource.DataSource {
	return &PostgresBranchBackupsDataSource{}
}
...
func (r *PostgresBranchBackupsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_postgres_branch_backups"
}
...
func (r *PostgresBranchBackupsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PostgresBranchBackups DataSource",
...
func (r *PostgresBranchBackupsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PostgresBranchBackupsDataSourceModel
	...
	data.Data = nil
	resp.Diagnostics.Append(data.RefreshFromOperationsListPostgresBranchBackupsResponseBody(ctx, res.Object)...)
