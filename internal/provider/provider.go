...
func (p *PlanetscaleProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewNekiBackupPolicyResource,
		NewNekiBranchResource,
		NewNekiBranchBackupResource,
		NewNekiBranchRoleResource,
		NewNekiConfigurationProfileResource,
		NewNekiRedactedBranchRoleResource,
		NewNekiRouterResource,
		NewPostgresBackupPolicyResource,
		NewPostgresBouncerResource,
...
func (p *PlanetscaleProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewNekiBackupPoliciesDataSource,
		NewNekiBackupPolicyDataSource,
		NewNekiBranchDataSource,
		NewNekiBranchBackupDataSource,
		NewNekiBranchBackupsDataSource,
		NewNekiBranchRoleDataSource,
		NewNekiBranchRolesDataSource,
		NewNekiConfigurationProfileDataSource,
		NewNekiConfigurationProfileParametersDataSource,
		NewNekiConfigurationProfileShardsDataSource,
		NewNekiConfigurationProfilesDataSource,
		NewNekiDatabaseDataSource,
		NewNekiRedactedBranchRoleDataSource,
		NewNekiRouterDataSource,
		NewNekiRouterParametersDataSource,
		NewNekiRoutersDataSource,
		NewNekiShardsDataSource,
		NewOrganizationDataSource,
		NewOrganizationsDataSource,
		NewPostgresBackupPoliciesDataSource,
		NewPostgresBackupPolicyDataSource,
		NewPostgresBouncerDataSource,
		NewPostgresBouncersDataSource,
		NewPostgresBranchDataSource,
		NewPostgresBranchBackupDataSource,
		...
		NewVitessBranchBackupDataSource,
