...
func (p *PlanetscaleProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewNekiRoleDataSource,
		NewNekiRolesDataSource,
		NewNekiRouterDataSource,
		NewNekiRoutersDataSource,
		NewNekiShardDataSource,
		NewNekiShardsDataSource,
		NewNekiSidecarDataSource,
