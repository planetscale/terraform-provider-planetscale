...
func (r *RolesDataSourceModel) RefreshFromOperationsListRolesResponseBody(ctx context.Context, resp *operations.ListRolesResponseBody) diag.Diagnostics {
...
func (r *RolesDataSourceModel) ToOperationsListRolesRequest(ctx context.Context) (*operations.ListRolesRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
