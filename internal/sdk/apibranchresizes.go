...
type APIBranchResizes struct {
	rootSDK          *PlanetScale
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAPIBranchResizes(rootSDK *PlanetScale, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APIBranchResizes {
	return &APIBranchResizes{
		rootSDK:          rootSDK,
...
// UpdateBranchResizeRequest - Upsert a resize request
// ### Authorization
...
func (s *APIBranchResizes) UpdateBranchResizeRequest(ctx context.Context, request operations.UpdateBranchResizeRequestRequest, opts ...operations.Option) (*operations.UpdateBranchResizeRequestResponse, error) {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "update_branch_resize_request",
		OAuth2Scopes:     nil,
	...
	res := &operations.UpdateBranchResizeRequestResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.UpdateBranchResizeRequestResponseBody
...
// GetBranchResizeRequest - Get a branch resize request
// ### Authorization
// A service token or OAuth token must have at least one of the following access or scopes in order to use this API endpoint:
//
// **Service Token Accesses**
...
// | Branch | `read_branch` |
func (s *APIBranchResizes) GetBranchResizeRequest(ctx context.Context, request operations.GetBranchResizeRequestRequest, opts ...operations.Option) (*operations.GetBranchResizeRequestResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{organization}/databases/{database}/branches/{branch}/resizes/{resize}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get_branch_resize_request",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	if o.Polling != nil {
		...
		case "WaitForResizeComplete":
			return s.getBranchResizeRequestWaitForResizeComplete(ctx, hookCtx, req, o)
		}
	}
...
func (s *APIBranchResizes) getBranchResizeRequest(ctx context.Context, hookCtx hooks.HookContext, req *http.Request, o operations.Options) (*operations.GetBranchResizeRequestResponse, error) {
	...
	res := &operations.GetBranchResizeRequestResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetBranchResizeRequestResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// Use with GetBranchResizeRequest by adding the operations.WithPolling option.
...
func (s *APIBranchResizes) getBranchResizeRequestWaitForResizeComplete(ctx context.Context, hookCtx hooks.HookContext, req *http.Request, o operations.Options) (*operations.GetBranchResizeRequestResponse, error) {
	...
	var res *operations.GetBranchResizeRequestResponse
	...
	for i := 1; i <= *o.Polling.LimitCount; i++ {
		...
		res, err = s.getBranchResizeRequest(ctx, hookCtx, req, o)
		...
		if failureCriteriaMet {
			failureCriteriaMet = res.Object.ResizeRequestState == "canceled"
			failureCriteriaMessage = append(failureCriteriaMessage, "Response body at /resize_request_state was \"canceled\"")
		}
		...
		if successCriteriaMet {
			successCriteriaMet = res.Object.ResizeRequestState == "completed"
		}
