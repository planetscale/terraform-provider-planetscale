...
// OAuthTokens -           Resources for managing OAuth tokens.
...
func newOAuthTokens(rootSDK *Planetscale, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OAuthTokens {
	return &OAuthTokens{
		rootSDK:          rootSDK,
...
//
//	`write_oauth_tokens`
func (s *OAuthTokens) CreateOauthToken(ctx context.Context, request operations.CreateOauthTokenRequest, opts ...operations.Option) (*operations.CreateOauthTokenResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{organization}/oauth-applications/{id}/token", request, nil)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateOauthTokenResponseBody
