...
type APINekiAdmins struct {
	rootSDK          *PlanetScale
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAPINekiAdmins(rootSDK *PlanetScale, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APINekiAdmins {
	return &APINekiAdmins{
		rootSDK:          rootSDK,
...
// GetNekiAdmin - Get the admin for a Neki branch
// ### Authorization
...
// | Branch | `read_branch` |
func (s *APINekiAdmins) GetNekiAdmin(ctx context.Context, request operations.GetNekiAdminRequest, opts ...operations.Option) (*operations.GetNekiAdminResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{organization}/databases/{database}/branches/{branch}/admin", request, nil)
	if err != nil {
	...
	if o.Polling != nil {
		...
		case "WaitForReady":
			return s.getNekiAdminWaitForReady(ctx, hookCtx, req, o)
		}
	}
...
func (s *APINekiAdmins) getNekiAdmin(ctx context.Context, hookCtx hooks.HookContext, req *http.Request, o operations.Options) (*operations.GetNekiAdminResponse, error) {
	...
	res := &operations.GetNekiAdminResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetNekiAdminResponseBody
...
// Use with GetNekiAdmin by adding the operations.WithPolling option.
...
func (s *APINekiAdmins) GetNekiAdminWaitForReady() polling.ConfigFunc {
...
func (s *APINekiAdmins) getNekiAdminWaitForReady(ctx context.Context, hookCtx hooks.HookContext, req *http.Request, o operations.Options) (*operations.GetNekiAdminResponse, error) {
	...
	var res *operations.GetNekiAdminResponse
	...
	for i := 1; i <= *o.Polling.LimitCount; i++ {
		...
		res, err = s.getNekiAdmin(ctx, hookCtx, req, o)
...
// UpdateNekiAdmin - Update the admin for a Neki branch
// ### Authorization
// A service token or OAuth token must have at least one of the following access or scopes in order to use this API endpoint:
//
// **Service Token Accesses**
...
func (s *APINekiAdmins) UpdateNekiAdmin(ctx context.Context, request operations.UpdateNekiAdminRequest, opts ...operations.Option) (*operations.UpdateNekiAdminResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.UpdateNekiAdminResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.UpdateNekiAdminResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
