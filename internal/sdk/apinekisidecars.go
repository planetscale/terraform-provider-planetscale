...
type APINekiSidecars struct {
	rootSDK          *PlanetScale
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAPINekiSidecars(rootSDK *PlanetScale, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APINekiSidecars {
	return &APINekiSidecars{
		rootSDK:          rootSDK,
...
// GetNekiSidecar - Get a sidecar for a Neki branch
// ### Authorization
...
// | Branch | `read_branch` |
func (s *APINekiSidecars) GetNekiSidecar(ctx context.Context, request operations.GetNekiSidecarRequest, opts ...operations.Option) (*operations.GetNekiSidecarResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}", request, nil)
	if err != nil {
	...
	if o.Polling != nil {
		...
		case "WaitForReady":
			return s.getNekiSidecarWaitForReady(ctx, hookCtx, req, o)
		}
	}
...
func (s *APINekiSidecars) getNekiSidecar(ctx context.Context, hookCtx hooks.HookContext, req *http.Request, o operations.Options) (*operations.GetNekiSidecarResponse, error) {
	...
	res := &operations.GetNekiSidecarResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetNekiSidecarResponseBody
...
// Use with GetNekiSidecar by adding the operations.WithPolling option.
...
func (s *APINekiSidecars) GetNekiSidecarWaitForReady() polling.ConfigFunc {
...
func (s *APINekiSidecars) getNekiSidecarWaitForReady(ctx context.Context, hookCtx hooks.HookContext, req *http.Request, o operations.Options) (*operations.GetNekiSidecarResponse, error) {
	...
	var res *operations.GetNekiSidecarResponse
	...
	for i := 1; i <= *o.Polling.LimitCount; i++ {
		...
		res, err = s.getNekiSidecar(ctx, hookCtx, req, o)
...
// UpdateNekiSidecar - Update a sidecar for a Neki branch
// ### Authorization
// A service token or OAuth token must have at least one of the following access or scopes in order to use this API endpoint:
//
// **Service Token Accesses**
...
func (s *APINekiSidecars) UpdateNekiSidecar(ctx context.Context, request operations.UpdateNekiSidecarRequest, opts ...operations.Option) (*operations.UpdateNekiSidecarResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "update_neki_sidecar",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.UpdateNekiSidecarResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.UpdateNekiSidecarResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
