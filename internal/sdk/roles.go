...
// CreateNekiRole - Create Neki role credentials
// ### Authorization
// A service token or OAuth token must have at least one of the following access or scopes in order to use this API endpoint:
//
// **Service Token Accesses**
...
func (s *Roles) GetNekiRole(ctx context.Context, request operations.GetNekiRoleRequest, opts ...operations.Option) (*operations.GetNekiRoleResponse, error) {
	...
	if o.Polling != nil {
		...
		case "WaitForReady":
			return s.getNekiRoleWaitForReady(ctx, hookCtx, req, o)
		}
	}
...
// Use with GetNekiRole by adding the operations.WithPolling option.
...
func (s *Roles) GetNekiRoleWaitForReady() polling.ConfigFunc {
...
func (s *Roles) getNekiRoleWaitForReady(ctx context.Context, hookCtx hooks.HookContext, req *http.Request, o operations.Options) (*operations.GetNekiRoleResponse, error) {
	...
	var res *operations.GetNekiRoleResponse
	...
	for i := 1; i <= *o.Polling.LimitCount; i++ {
		...
		res, err = s.getNekiRole(ctx, hookCtx, req, o)
...
// UpdateNekiRole - Update a Neki role name
// ### Authorization
// A service token or OAuth token must have at least one of the following access or scopes in order to use this API endpoint:
//
// **Service Token Accesses**
...
// DeleteNekiRole - Delete Neki role credentials
// ### Authorization
// A service token or OAuth token must have at least one of the following access or scopes in order to use this API endpoint:
//
// **Service Token Accesses**
