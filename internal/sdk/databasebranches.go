...
// UpdateVitessBranchSafeMigrations - Update safe migrations for a Vitess branch
func (s *DatabaseBranches) UpdateVitessBranchSafeMigrations(ctx context.Context, request operations.UpdateVitessBranchSafeMigrationsRequest, opts ...operations.Option) (*operations.UpdateVitessBranchSafeMigrationsResponse, error) {
	...
	res := &operations.UpdateVitessBranchSafeMigrationsResponse{
