...
func (u *UpdateVitessBranchRegionData) GetMysqlSupported() bool {
	if u == nil {
		return false
	}
...
func (u *UpdateVitessBranchRegionData) GetPostgresqlSupported() bool {
	if u == nil {
		return false
	}
...
func (u *UpdateVitessBranchResponseBody) GetDeletionProtectionManaged() bool {
	if u == nil {
		return false
	}
