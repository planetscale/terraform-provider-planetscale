...
func (g *GetDatabaseDataSource) GetPort() int64 {
	if g == nil {
		return 0
	}
	return g.Port
...
func (g *GetDatabaseResponseBody) GetBranchesCount() int64 {
	if g == nil {
		return 0
	}
...
func (g *GetDatabaseResponseBody) GetOpenSchemaRecommendationsCount() int64 {
	if g == nil {
		return 0
	}
...
func (g *GetDatabaseResponseBody) GetDevelopmentBranchesCount() int64 {
	if g == nil {
		return 0
	}
...
func (g *GetDatabaseResponseBody) GetProductionBranchesCount() int64 {
	if g == nil {
		return 0
	}
...
func (g *GetDatabaseResponseBody) GetIssuesCount() int64 {
	if g == nil {
		return 0
	}
...
func (g *GetDatabaseResponseBody) GetDefaultBranchShardCount() int64 {
	if g == nil {
		return 0
	}
...
func (g *GetDatabaseResponseBody) GetDefaultBranchReadOnlyRegionsCount() int64 {
	if g == nil {
		return 0
	}
...
func (g *GetDatabaseResponseBody) GetDefaultBranchTableCount() int64 {
	if g == nil {
		return 0
	}
