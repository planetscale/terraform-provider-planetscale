...
// Generated from OpenAPI doc version v1 and generator version 2.748.0
...
func New(opts ...SDKOption) *Planetscale {
	sdk := &Planetscale{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.0.1 2.748.0 v1 github.com/planetscale/terraform-provider-planetscale/internal/sdk",
