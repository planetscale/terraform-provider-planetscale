...
// Generated from OpenAPI doc version v1 and generator version 2.788.5
...
func New(opts ...SDKOption) *Planetscale {
	sdk := &Planetscale{
		SDKVersion: "1.0.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.0.0 2.788.5 v1 github.com/planetscale/terraform-provider-planetscale/internal/sdk",
