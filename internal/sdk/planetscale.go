...
// Generated from OpenAPI doc version v1 and generator version 2.879.13
...
func New(opts ...SDKOption) *PlanetScale {
	sdk := &PlanetScale{
		SDKVersion: "1.0.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.0.0 2.879.13 v1 github.com/planetscale/terraform-provider-planetscale/internal/sdk",
