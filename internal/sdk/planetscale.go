...
// Generated from OpenAPI doc version v1 and generator version 2.781.2
...
func New(opts ...SDKOption) *Planetscale {
	sdk := &Planetscale{
		SDKVersion: "1.0.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.0.0 2.781.2 v1 github.com/planetscale/terraform-provider-planetscale/internal/sdk",
