...
// GetNekiDatabase - Get a Neki database
// ### Authorization
// A service token or OAuth token must have at least one of the following access or scopes in order to use this API endpoint:
//
// **Service Token Accesses**
...
// | Organization | `read_databases` |
// | Database | `read_database` |
func (s *Databases) GetNekiDatabase(ctx context.Context, request operations.GetNekiDatabaseRequest, opts ...operations.Option) (*operations.GetNekiDatabaseResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.GetNekiDatabaseResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetNekiDatabaseResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
